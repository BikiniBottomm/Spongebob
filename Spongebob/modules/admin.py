...
*Admins only:*
 ...
 • `/reloadadmin`*:* force refresh the admins list
 • `/zombies` *:* Scan deleted accounts
 • `/zombies clean` *:* Cleans deleted accounts
 • `/kicknonacc` *:* Cleaning the account is not used 
 • `/report` *:* Reporting a user to admin
"""
...
ADMIN_REFRESH_HANDLER = CommandHandler(
    "reloadadmin", refresh_admin, filters=Filters.group)
